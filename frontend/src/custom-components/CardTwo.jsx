      ...
      <div className="basis-full bg-white rounded-md group sm:basis-56 lg:basis-60 2xl:basis-80">
        ...
        <div className="px-2  pb-2">
          ...
          <div className="flex flex-col gap-1 mt-4">
            ...
            <button
              className="bg-red-400 text-center text-white text-sm px-1 py-1.5 rounded-md transition-all duration-300 hover:bg-red-600"
            ...
            <button
              ...
              className="bg-sky-400 text-center text-white text-sm px-1 py-1.5 rounded-md transition-all duration-300 hover:bg-sky-700"
            >
              Republish Auction
            </button>
          </div>
